...
function validator(preamble, check) {
...
function find_first_invalid(data, preamble_length) {
...
function contiguos(data, invalid) {
    let iter_start = 0;
...
//# sourceMappingURL=AOC2020_9.js.map